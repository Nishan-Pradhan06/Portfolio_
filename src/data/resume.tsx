...
export const DATA = {
  ...
  education: [
    {
      school: 'Itahari Namuna College (INC)',
      href: 'https://namunacollege.edu.np',
      degree: 'BCA 5th Semester',
      logoUrl: '/inc.jpg',
      start: '2022',
      end: '2026',
    },
  ...
  projects: [
    {
      title: 'Deal Sell',
      href: 'https://github.com/Nishan-Pradhan06/Dealsell_e-commerce',
      dates: 'Apr 2025 - Jul 2025',
      active: true,
      description:
        'Deal Sell is an eCommerce platform developed as a part of a 5th semester academic project. It allows users to buy and sell products, providing a seamless shopping experience.',
      technologies: [
        'Flutter',
        'Dart',
        'Firebase',
  ...
  hackathons: [
    {
      title: 'Best Frontend - INC Webathon 2023',
      dates: 'November 23rd - 25th, 2018',
      location: 'Itahari, Sunsari',
      description:
        'Developed a web application which delivered the college website on the topic of Student Management System. The project was created by the Cyber Sapiens team from second semester students of Itahari Namuna College during the INC Webathon competition.',
      image:
        '/ict.png',
      mlh: '/ict.png',
      links: [
       {
          ...
          href: 'https://itaharinamunacollege.vercel.app/',
        },
        {
          title: 'Github',
          icon: <Icons.github className="h-4 w-4" />,
          href: 'https://github.com/Nishan-Pradhan06/INC-site-webathon',
        },
      ],
    },
    // {
